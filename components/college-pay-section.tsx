...
import { PremiumAnimation, StaggerContainer } from "@/components/premium-animations"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <PremiumAnimation type="fade" delay={0.3} className="mb-10" viewport={true}>
              <h2 className="text-5xl md:text-6xl font-bold text-white mb-6">College Pay</h2>
          ...
          <PremiumAnimation type="slide" x={30} viewport={true} className="relative">
            <div className="relative h-[500px] w-full">
              {/* Card image */}
              <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-[80%] h-auto z-20">
                <Image
                  src="/placeholder.svg?height=400&width=600&text=Credit+Card"
