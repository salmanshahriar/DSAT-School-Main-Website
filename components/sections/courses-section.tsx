...
আমাদের Exclusive Mentorship Program আপনাকে SAT-এর প্রতিটি অংশে দক্ষ করে তুলবে এবং 1400+ স্কোর অর্জনের পথে এগিয়ে নিয়ে যাবে!`,
  recorded: `
  আপনার Digital SAT প্রস্তুতি শুরু করতে চান কিন্তু ব্যয়বহুল কোর্সের কারণে সিদ্ধান্ত নিতে পারছেন না? চিন্তার কিছু নেই! DSAT Premium Recorded Course দিচ্ছে সাশ্রয়ী মূল্যে প্রিমিয়াম কোয়ালিটির কোর্স, যেখানে পাবেন সম্পূর্ণ গাইডলাইন ও অনুশীলনের সুবিধা।

  কেন আমাদের DSAT Recorded Course?
✅ সাশ্রয়ী ফি – অন্যান্য কোর্সের তুলনায় অনেক কম খরচে সর্বোচ্চ মানের প্রস্তুতি
 ✅ 80+ ঘন্টা রেকর্ডেড ক্লাস – নিজের সুবিধামতো শিখুন, বারবার দেখার সুযোগ
 ✅ Topic-wise Theory & Solve Classes – প্রতিটি টপিকের গভীর বিশ্লেষণ
 ✅ Unlimited Topic-wise Quizzes – কনসেপ্ট বুঝতে পর্যাপ্ত অনুশীলন
 ✅ Exclusive Online Practice Portal – নিয়মিত মক টেস্ট ও প্রাকটিস
 ✅ 24/7 Problem Solving Support – ডিসকর্ড গ্রুপে প্রশ্ন করলেই উত্তর পাবেন


কোর্সটি কাদের জন্য?
🔹 যারা SAT প্রস্তুতি নতুনভাবে শুরু করছেন
...
export default function CoursesSection() {
  ...
  const featuredCourseDetails = [
    ...
    { icon: <CheckCircle className="h-3 w-3" />, text: "Desmos Hacks" },
