...
export default function Navbar() {
  ...
  return (
    <>
      <div className="fixed top-0 w-full bg-yellow-100 text-center py-2 z-50">
        <p className="text-sm text-gray-800">This site is under development</p>
      </div>
      <motion.header
        className={cn(
          "fixed top-10 w-full z-40 transition-all duration-500",
